...
client.on("message", message => {
    if (message.content === "-rules") {
     ...
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`
  ●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●
:crown::crown: [ ★・rules   |  قوانين السيرفر  ]:crown:: :crown: 

       :crown:『1』『ممنوع طلب رتبه Support』:crown: 
:crown:『ممنوع تكرار الرسائل يؤدي للميوت』『2』:crown:
:crown:『ممنوع نشر اي روابط سيرفرات ديسكورد』『3』:crown:
:crown:『ممنوع كتابه اي رساله الا في الروم الخاص بها』『4』:crown:
:crown:『ممنوع التدخل في شئون المسؤلين ايا كانت هيا』『5』:crown:
:crown:『ممنوع منعا باتا السب او التكلم في الامور الدينيه』『6』:crown:
:crown:『ممنوع طلب فك الميوت اذا انت في حاله ميوت』『7』:crown:
:crown:『ممنوع التلفظ بسيره الام او الاب』『8』:crown:
     :crown:『مع تحيات المسؤل عن السيرفر』 :crown:
:crown: @╲⎝⧹『ツ𝕹𝕶-𝕽𝕬𝕸𝕻𝕷𝕰ヅ』⧸⎠╱#4254 :crown: 
   :crown:『وان شاء الله السيرفر بعجبك』:crown: 
...
client.on("message", message => {
    if (message.content === "-rules") {
     ...
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`
  ●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●
:crown::crown: [ ★・feat   |  مميزات السيرفر  ]:crown:: :crown: 


:crown:『دعم فني مميز جدا موجودين 24 ساعه』『1』:crown:
:crown:『لاي اقتراح يفيدنا في غرفه الاقتراحات』『2』:crown:
:crown:『في 15 روم للصوت تقدر تسمع اغاني』『3』:crown:
:crown:『السيرفر فيه العاب تقدر تلعب 24 ساعه』『4』:crown: 
:crown:『بوتات ترحب فيك عند الدخول للسيرفر』『5』:crown:
:crown:『تقدر تحصل رتبه بعدم المخالفه للقوانين』『6』:crown:
     :crown:『غرف مخصصه للاوامر و الالعاب』『7』:crown: 
      :crown:『مع تحيات المسؤل عن السيرفر』:crown:
:crown: @╲⎝⧹『ツ𝕹𝕶-𝕽𝕬𝕸𝕻𝕷𝕰ヅ』⧸⎠╱#4254 :crown: 
 :crown: 『وان شاء الله السيرفر يعجبك』:crown:
